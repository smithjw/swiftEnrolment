...
defaults write /Library/Management/management_info.plist enrol_login_policy_start "$(date +%s)"

jamf_check "manage"
jamf_check "recon"
jamf_check "policy"

defaults write /Library/Management/management_info.plist enrol_login_policy_end "$(date +%s)"
